...
typedef struct {
  ...
  long     transactionReceivedBytes; //transaction received bytes
  long     transactionSentBytes;     //transaction sent bytes
  long     compactBlockReceivedBytes;       //compactBlock Received Bytes
  long     compactBlockSentBytes;           //compactBlock Received Bytes
  long     getblocktxnReceivedBytes;        // getblocktxn Received Bytes
  long     getblocktxnSentBytes;            //getblocktxn Received Bytes
  long     blocktxnReceivedBytes;           // blocktxn Received Bytes
  long     blocktxnSentBytes;               //blocktxn Received Bytes
  long     invTxnReceivedBytes;             // invtxn Received Bytes
  long     invTxnSentBytes;                 //invtxn Received Bytes
  long     getDataTxnReceivedBytes;         // getdatatxn Received Bytes
  long     getDataTxnSentBytes;             //getdatatxn Received Bytes
} nodeStatistics;
...
public:
  ...
  /**
   * Check if the transaction has been included in the blockchain.
   */
  bool HasTransaction(const std::string transactionShortHash) const;
